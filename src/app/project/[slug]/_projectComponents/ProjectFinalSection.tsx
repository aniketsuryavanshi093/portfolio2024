    ...
    return (
        <div className='w-full'>
            <div className='flex justify-center flex-col align-center gap-4 w-[80%] lg:w-[60%] m-auto'>
                <p className='lg:text-3xl text-xl text-center'>{projectinfo?.projectfinalsection?.sectiontitle}</p>
            ...
            <div className='w-full flex justify-center flex-col relative align-start lg:h-[80vh] h-[65vh]' style={{ backgroundImage: "url('/images/projects/bottomrectangle.png')", backgroundSize: "100% 100%" }}>
...
export default SectionWrapper(ProjectFinalSection, "projectinfofinal", " w-full lg:w-[95%] 2xl:w-[93%] py-5 md:mt-[100px]  xl:mt-[100px]   px-4")
