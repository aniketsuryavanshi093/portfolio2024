...
const ProjectSection3 = () => {
    ...
    return (
        <>
            <div className=''>
                <div className=' h-[60vh] w-full flex justify-center flex-col relative align-start  lg:h-[100vh]' style={{ backgroundImage: "url('/images/projects/projectbg2.png')", backgroundSize: "100% 100%" }}>
                    <div className=" lg:mb-72 w-[90%] ">
                        <p className='lg:text-3xl text-xl text-right'>Important Feature:</p>
                        <p className='text-mainpara   text-right lg:text-3xl text-xl'>{projectinfo?.projectredbackgroundsection?.sectiontitle}</p>
...
export default SectionWrapper(ProjectSection3, "projectinfo3", "  2xl:w-full py-5 md:mt-[100px]  xl:mt-[220px] mt-[120px] ps-4")